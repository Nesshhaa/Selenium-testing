...
class DodavanjeUKorpuTest {

	private Logger log = Logger.getLogger(DodavanjeUKorpuTest.class.getName());
	...
	@Test
	  public void dodavanjeUKorpu() {
	    ...
	    String sb = "\nIme testa : Dodavanje proizvoda u korpu \n" + "Opis testa : Test proverava da li se proizvodi dodaju u korpu \n"
				+ "Test je uspesan \n\n";
